...
function configureEbayPoliciesEnvironment(int $companyId): void
{
    ...
    $settings->set('commerce.marketplace.ebay.client_id', 'client-policy-test', $scope);
    $settings->set('commerce.marketplace.ebay.client_secret', 'secret-policy-test', $scope, encrypted: true);
