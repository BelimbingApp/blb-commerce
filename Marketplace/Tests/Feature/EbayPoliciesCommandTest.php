...
function configureEbayCommandTestEnvironment(int $companyId): void
{
    ...
    $settings->set('commerce.marketplace.ebay.client_id', 'client-cmd-test', $scope);
    $settings->set('commerce.marketplace.ebay.client_secret', 'secret-cmd-test', $scope, encrypted: true);
